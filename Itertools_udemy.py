...
count = 0
for val in itertools.count(10,5): # We can only specify start and step, but not end. It is defined using counter
    if count > 10:
        break
    else:
        print(val, end=" ")
...
l = [1,2,3]
print(list(itertools.permutations(l,2))) # parameters: list and no of items for combination/permutaion
