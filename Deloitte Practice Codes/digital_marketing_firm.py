...
details = {"campaign_name": campaign_name, "no_of_emails": no_of_emails, "open_rate": open_rate}
dataframe = pd.DataFrame(details)
mean_of_opening = dataframe["open_rate"].mean() # Find the mean of 'open_rate' values column
