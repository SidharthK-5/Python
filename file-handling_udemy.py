...
content = f.readlines()
print(content[:1]) # Prints only first line. Since the earlier statement covered upto 7 characters, this statement will print rest of the characters in the line
