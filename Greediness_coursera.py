...
"""
? means optional
.* means any chara occurence 0 or more times. But this is greedy, so it will look for as many chara in b/w - Greediness
...
"""
Problem 1
find a string starting with crypto amd ending with coinm with atmost 30 chara in b/w
"""
...
"""
Problem 3
Replace Alice Wonderland with 'Alice Doe', but not to replace occurences of 'Alice Wonderland' within single quotes
"""
# Negative lookahead ?!
