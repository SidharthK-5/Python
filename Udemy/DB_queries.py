"""
Connecting to a databse using SQLite3 and performing transactions
"""

import sqlite3

connection = sqlite3.connect("data/example1.db")
c = connection.cursor()
...
"""All statements are to be commented once it is run successfully"""
...
# c.execute("DELETE FROM EMP WHERE ID=103")s
# connection.execute("COMMIT")
