...
GAME_DATA = {9: 27, 16: 7, 18: 37, 25: 54, 28: 51, 56: 64, 59: 17, 63: 19, 67: 30, 68: 88, 76: 97, 79: 100, 87: 24, 93: 69, 95: 75, 99: 77}
...
def play():
    ...
    while True:
        if turn % 2 == 0:
            # Player 1's turn
            print(f"\n{player_one}'s turn")
            player_one_position, dice_value = handle_turn(player_one, player_one_position)
            ...
            # Player 2's turn
            print(f"\n{player_two}'s turn")
            player_two_position, dice_value = handle_turn(player_two, player_two_position)
