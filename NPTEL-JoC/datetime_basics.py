...
print("Current year without century as decimal number: ", end="")
...
print("Week number of this year (Sun as 1st day of the week): ", end="")
print(f"{datetime.date.today().strftime('%U')}")
print("Week number of this year (Mon as 1st day of the week): ", end="")
print(f"{datetime.date.today().strftime('%W')}")
...
print("Date and Time (12 hr): ", end="")
print(f"{datetime.datetime.now().strftime('%d/%m/%Y, %I:%M:%S %p')}")
print(
